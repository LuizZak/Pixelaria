...
namespace PixelariaTests.Utils
{
    ...
    public class UtilsTests
    {
        ...
        {
            Assert.AreEqual("Test Camelcase", Utilities.DePascalCase("TestCamelcase"));
            Assert.AreEqual("Test HTML Camelcase", Utilities.DePascalCase("TestHTMLCamelcase"));
            Assert.AreEqual("Test", Utilities.DePascalCase("Test"));
            Assert.AreEqual("TEST", Utilities.DePascalCase("TEST"));
        }
