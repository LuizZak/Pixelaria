...
namespace PixelariaTests.Views.ExportPipeline.PipelineNodePanel
{
    ...
    public class ExportPipelineNodesPanelManagerTests
    {
        ...
        public void TestInitialize()
        {
            ...
            var renderManager = new Direct2DRenderManager();
            ...
            _sut = new ExportPipelineNodesPanelManager(_container, renderManager, new TestInvalidateTarget(),  new PipelineNodeBitmapGenerator(_control));
