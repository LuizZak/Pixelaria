...
namespace PixelariaTests.Views.ExportPipeline.ExportPipelineFeatures
{
    ...
    public class ControlViewFeatureTests
    {
        ...
        {
            // Arrange
            var controlViewFeature = new ControlViewFeature(new ExportPipelineControl(), new TestDirect2DRender());
        ...
        {
            var sut = new ControlViewFeature(new ExportPipelineControl(), new TestDirect2DRender());
