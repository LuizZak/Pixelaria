...
namespace PixelariaTests.Views.ExportPipeline.ExportPipelineFeatures
{
    ...
    public class ControlViewFeatureTests
    {
        ...
        {
            // Arrange
            var controlViewFeature = new ControlViewFeature(new ExportPipelineControl(), new TestDirect2DRenderManager());
            ...
            var rendererStub = MockRepository.GenerateStub<IRenderManager>();
            ...
            var context = new ControlRenderingContext(null, clipStub, null, null, rendererStub);
