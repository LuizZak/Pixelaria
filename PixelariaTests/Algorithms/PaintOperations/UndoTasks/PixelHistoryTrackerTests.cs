...
namespace PixelariaTests.Algorithms.PaintOperations.UndoTasks
{
    /// <summary>
    ...
    public class PixelHistoryTrackerTests
    {
        ...
        {
            // Create the tracker
            var tracker = new PixelHistoryTracker(true, 12);
        ...
        {
            // Create the tracker
            var tracker = new PixelHistoryTracker(false, 12);
        ...
        {
            var undo1 = new PixelHistoryTracker.PixelUndo(0, 0, 0, 0xFF, 0xFE);
            var undo2 = new PixelHistoryTracker.PixelUndo(0, 0, 0, 0x00, 0xFE);
        ...
        {
            var undo1 = new PixelHistoryTracker.PixelUndo(0, 0, 0, 0xFF, 0xFE);
            var undo2 = new PixelHistoryTracker.PixelUndo(1, 0, 0, 0xFF, 0xFE);
        ...
        {
            var undo1 = new PixelHistoryTracker.PixelUndo(0, 0, 0, 0xFF, 0xFE);
            var undo2 = new PixelHistoryTracker.PixelUndo(0, 1, 0, 0xFF, 0xFE);
