...
namespace PixLibTests.Data.Persistence
{
    /// <summary>
    ...
    public class PersistenceTests
    {
        ...
        public void TestFileLoaderSaver()
        {
            ...
            TestUtils.AssertBundlesEqual(bundle, loadedBundle,
        ...
        public void TestPersistenceClass()
        {
            ...
            TestUtils.AssertBundlesEqual(originalBundle, newBundle,
            ...
            TestUtils.AssertBundlesEqual(v8Bundle, newBundle,
        ...
        private static byte[] LegacyGetHashForBitmap([NotNull] Image bitmap)
        {
