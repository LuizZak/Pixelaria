...
{
    internal struct BLFontFaceCore
    {
        internal IntPtr Impl;
    }

    // ReSharper disable InconsistentNaming
    internal static class UnsafeFontFaceCore
    {
        [DllImport("blend2d.dll", CharSet = CharSet.Unicode)]
        public static extern uint blFontFaceInit(ref BLFontFaceCore context);

        [DllImport("blend2d.dll", CharSet = CharSet.Unicode)]
        public static extern uint blFontFaceCreateFromFile(ref BLFontFaceCore context, IntPtr fileName, BLFileReadFlags readFlags);
        ...
        [DllImport("blend2d.dll", CharSet = CharSet.Unicode)]
        public static extern uint blFontFaceReset(ref BLFontFaceCore context);
    }
}
