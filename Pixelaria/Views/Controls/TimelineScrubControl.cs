...
namespace Pixelaria.Views.Controls
{
    ...
    public class TimelineScrubControl : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            var timelineRect = GetTimelineRect();
        ...
        private void DrawFrameIndicator(PaintEventArgs e, int frame, float alpha = 1)
        {
            ...
            playheadPos1.X = GetFramePosition(frame);
            playheadPos1.Y = 0;
            ...
            else if (frameDisplayType == TimelineFrameDisplayType.FrameNumber)
            {
                ...
                e.Graphics.DrawString(frameText, _font, textBrush, playheadPos1.X - frameTextSize.Width / 2, playheadPos1.Y - 1);
        ...
        private int GetFramePosition(int frameIndex)
        {
            return firstKnob.KnobThickness / 2 + (int)((float)(frameIndex - minimum) / Math.Max(1, maximum - minimum) * (Width * ScrollScaleWidth - firstKnob.KnobThickness - 1)) - (int)ScrollX;
        }
    ...
    /// <summary>
    /// The event arguments for a <see cref="TimelineScrubControl.FrameChanged"/> or <see cref="TimelineControl.FrameChanged"/> event
    /// </summary>
